<div class="container my-4"> <a href="<?= $router->generate('student-create')?>" class="btn btn-success float-right">Ajouter</a>
    ...
    <table class="table table-hover mt-4">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-right">
                    <a href="<?= $router->generate('student-update').$currentStudent->getId()?>" class="btn btn-sm btn-warning">
